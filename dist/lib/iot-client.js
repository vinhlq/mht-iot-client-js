...
var _awsIotDeviceSdk = _interopRequireDefault(require("aws-iot-device-sdk"));
...
class IoTClient {
  ...
  initClient(options) {
    ...
    this.client = _awsIotDeviceSdk.default.device({
      region: options.region || _config.default.awsRegion,
      // AWS IoT Host endpoint
      host: options.host || _config.default.awsIotHost,
