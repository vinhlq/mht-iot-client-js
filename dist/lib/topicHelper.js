...
exports.topicFromSubscriptionTopic = exports.roomFromNewMessageTopic = exports.identityIdFromNewMessageTopic = exports.formatRoomCardHeader = exports.capitalize = exports.topicFromParams = void 0;
...
var validateNewMessageTopic = function (topic) {
...
var validateSubscriptionTopic = function (topic) {
  if (!/^room\/(public|private)\/[a-zA-Z-1-9]+\/\+$/.test(topic)) {
...
var topicFromParams = function (params) {
  return `room/${params.roomType}/${params.roomName}`;
};
/**
 * Capitalize a string
 *
...
exports.topicFromParams = topicFromParams;
...
var formatRoomCardHeader = function (roomName) {
  validateTopic(roomName); // roomName: 'room/public/my-awesome-room'

  var roomNameEnding = roomName.split('/').pop(); // roomNameEnding: 'my-awesome-room'

  var segments = roomNameEnding.split('-').map(function (segment) {
    return capitalize(segment);
  }); // segments: ['My', 'Awesome', 'Room']

  return segments.join(' '); // return: 'My Awesome Room'
};
/**
...
exports.formatRoomCardHeader = formatRoomCardHeader;

var identityIdFromNewMessageTopic = function (topic) {
...
exports.identityIdFromNewMessageTopic = identityIdFromNewMessageTopic;

var roomFromNewMessageTopic = function (topic) {
  validateNewMessageTopic(topic);
...
exports.roomFromNewMessageTopic = roomFromNewMessageTopic;

var topicFromSubscriptionTopic = function (topic) {
  validateSubscriptionTopic(topic);
  return topic.substr(0, topic.lastIndexOf('/'));
};

exports.topicFromSubscriptionTopic = topicFromSubscriptionTopic;