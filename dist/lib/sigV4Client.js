...
sigV4Client.newClient = function (config) {
  ...
  awsSigV4Client.signRequest = function (request) {
    ...
    var queryParams = (0, _objectSpread2.default)({}, request.queryParams);
    var headers = (0, _objectSpread2.default)({}, request.headers); // If the user has not specified an override for Content type the use default
    ...
    var body = (0, _objectSpread2.default)({}, request.body); // override request body and set to empty when signing GET requests
    ...
    var parser = new URL(awsSigV4Client.endpoint);
